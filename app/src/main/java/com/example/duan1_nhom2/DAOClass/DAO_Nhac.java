...
public class DAO_Nhac {
    ...
    public static void uploadMusic(Uri uri, final DialogThemVaCapNhatNhac dialog, final Nhac nhac, final TextView textView, ImageView imageView) {
    ...
    public static void updateMusicWithAudioFile(Uri uri, final DialogThemVaCapNhatNhac dialog, final Nhac nhac, final TextView textView, ImageView imageView){
