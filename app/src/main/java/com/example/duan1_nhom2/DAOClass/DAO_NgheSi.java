...
public class DAO_NgheSi {
    ...
    public static void readOneArtist(String tenNgheSi, final NhacTrangChu_rvAdapter adapter1, final AlbumTrangChu_rvAdapter adapter2, final NgheSiFragment fragment){
    ...
    private static void uploadArtistWithImage(Uri uri, Context context, final DialogThemVaCapNhatNgheSi dialog, final NgheSi ngheSi, final TextView textView, ImageView imageView){
        //Truy cập đến bảng NgheSi
    ...
    private static void updateArtistWithImage(Uri uri, Context context, final DialogThemVaCapNhatNgheSi dialog, final NgheSi ngheSi, final TextView textView, ImageView imageView){
        if (uri == null){
            return;
        }
